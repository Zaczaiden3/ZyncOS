...
// Default to mock values if env vars are not set
// This prevents the app from crashing immediately if not configured
...
// Initialize Firebase
// We only initialize if we have a somewhat valid config, or we accept it might fail network calls
